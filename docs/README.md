...
块闻的目标是一个区块链新闻消息平台，在这里您可以获取最新和区块链相关的技术，新闻和资讯。首个版本将以微信小程序形式推出，目前我们在利用业余时间努力开发中。

## 参考

* [微信小程序介绍](https://developers.weixin.qq.com/miniprogram/introduction/index.html)
